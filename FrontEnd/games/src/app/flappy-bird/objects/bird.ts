...
export class Bird extends Phaser.GameObjects.Image {
  ...
  constructor(params) {
    ...
    (<Phaser.Physics.Arcade.Body>this.body).setGravityY(1000);
    (<Phaser.Physics.Arcade.Body>this.body).setSize(17, 12);
  ...
  update(): void {
    ...
    if (this.jumpKey.isDown && !this.isFlapping) {
      ...
      (<Phaser.Physics.Arcade.Body>this.body).setVelocityY(-350);
