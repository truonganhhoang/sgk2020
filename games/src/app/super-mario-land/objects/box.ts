...
export class Box extends Phaser.GameObjects.Sprite {
  ...
  private popUpCollectible(): void {
    (<Phaser.Physics.Arcade.Body>this.content.body).setVelocity(30, -50);
    (<Phaser.Physics.Arcade.Body>this.content.body).setAllowGravity(true);
    (<Phaser.Physics.Arcade.Body>this.content.body).setGravityY(-300);
  }
